...
export default function OperatorsPage() {
  ...
  async function createOperator(e: React.FormEvent) {
    e.preventDefault();
    setSaving(true);
    const res = await fetch('/api/operators', { method: 'POST', body: JSON.stringify(form) });
  ...
  async function toggleActive(p: Profile) {
    await fetch('/api/operators', { method: 'PATCH', body: JSON.stringify({ id: p.id, is_active: !p.is_active }) });
    load();
  }
