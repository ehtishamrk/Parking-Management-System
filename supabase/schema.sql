...
-- ---------- DATA RETENTION (keep 3 months, then purge) ----------
-- Deletes tickets/passes (and their dependent pass_entries) older than 3
-- months. Not scheduled automatically — see supabase/migrations/003_data_retention_cron.sql
-- to turn on the daily cron job once pg_cron is enabled for this project.
