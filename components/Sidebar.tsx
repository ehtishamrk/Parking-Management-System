...
import { LayoutDashboard, Tag, Palette, Users, Ticket, CreditCard, LogOut, ScanLine, PlusCircle } from 'lucide-react';
      ...
      <div className="flex md:flex-col w-full">
        <div className="px-5 py-5 flex items-center justify-between md:block">
          <div>
            ...
            <p className="text-[11px] uppercase tracking-[0.2em] text-steel mt-1">ParkStub</p>
          </div>
        </div>
